...
#if 0
  /* Ghostscript ¦�ΥХ��� closepath ���Ƥ��Ǥ��ʤ��Τǽ��������碌�롣 */
...
escv_setlinewidth(gx_device_vector * vdev, floatp width)
{
  ...
  /* ESC/Page �Ǥ���������ü���ܹ����������ϣ��ĤΥ��ޥ��ɤˤʤäƤ��뤿���ݻ����Ƥ����� */
  pdev -> lwidth = width;
...
escv_endpath(gx_device_vector * vdev, gx_path_type_t type)
{
  ...
  if (type & gx_path_type_clip) {
    ...
    if ( ( 0 != ESCV_FORCEDRAWPATH ) || ( 0 != pdev->ispath ) ) {
      /* �����å׻���
      ** �����åפˤ� gx_path_type_winding_number, gx_path_type_even_odd ��Ƚ�Ǥ�
      ** ɬ�פ��Ȼפ��� gs ¦���ղä��Ƥ��ʤ���
      ** �Ȥꤢ���� gx_path_type_even_odd ���ǥե����Ȥˤ��롣
      */
    ...
    if (type & gx_path_type_even_odd) {
      lputs(s, ESC_GS "0;2drpG");		/* �ɤ��Ĥ֤����� */
    } else {
      lputs(s, ESC_GS "0;1drpG");		/* �ɤ��Ĥ֤����� */
    }
  } else {
