...
const Jbig2ArithQe jbig2_arith_Qe[] = {
  { 0x5601,  (0x0|1) ^  0,  (0x0|1) ^  (0x0|0) ^ 0x80 },
  { 0x3401,  (0x0|2) ^  1,  (0x0|6) ^  1 },
  { 0x1801,  (0x0|3) ^  2,  (0x0|9) ^  2 },
  { 0x0AC1,  (0x0|4) ^  3, (0x0|12) ^  3 },
  { 0x0521,  (0x0|5) ^  4, (0x0|29) ^  4 },
  { 0x0221, (0x0|38) ^  5, (0x0|33) ^  5 },
  { 0x5601,  (0x0|7) ^  6,  (0x0|6) ^  (0x0|6) ^ 0x80 },
  { 0x5401,  (0x0|8) ^  7, (0x0|14) ^  7 },
  { 0x4801,  (0x0|9) ^  8, (0x0|14) ^  8 },
  { 0x3801, (0x0|10) ^  9, (0x0|14) ^  9 },
  { 0x3001, (0x0|11) ^ 10, (0x0|17) ^ 10 },
  { 0x2401, (0x0|12) ^ 11, (0x0|18) ^ 11 },
  { 0x1C01, (0x0|13) ^ 12, (0x0|20) ^ 12 },
  { 0x1601, (0x0|29) ^ 13, (0x0|21) ^ 13 },
  { 0x5601, (0x0|15) ^ 14, (0x0|14) ^ (0x0|14) ^ 0x80 },
  { 0x5401, (0x0|16) ^ 15, (0x0|14) ^ 15 },
  { 0x5101, (0x0|17) ^ 16, (0x0|15) ^ 16 },
  { 0x4801, (0x0|18) ^ 17, (0x0|16) ^ 17 },
  { 0x3801, (0x0|19) ^ 18, (0x0|17) ^ 18 },
  { 0x3401, (0x0|20) ^ 19, (0x0|18) ^ 19 },
  { 0x3001, (0x0|21) ^ 20, (0x0|19) ^ 20 },
  { 0x2801, (0x0|22) ^ 21, (0x0|19) ^ 21 },
  { 0x2401, (0x0|23) ^ 22, (0x0|20) ^ 22 },
  { 0x2201, (0x0|24) ^ 23, (0x0|21) ^ 23 },
  { 0x1C01, (0x0|25) ^ 24, (0x0|22) ^ 24 },
  { 0x1801, (0x0|26) ^ 25, (0x0|23) ^ 25 },
  { 0x1601, (0x0|27) ^ 26, (0x0|24) ^ 26 },
  { 0x1401, (0x0|28) ^ 27, (0x0|25) ^ 27 },
  { 0x1201, (0x0|29) ^ 28, (0x0|26) ^ 28 },
  { 0x1101, (0x0|30) ^ 29, (0x0|27) ^ 29 },
  { 0x0AC1, (0x0|31) ^ 30, (0x0|28) ^ 30 },
  { 0x09C1, (0x0|32) ^ 31, (0x0|29) ^ 31 },
  { 0x08A1, (0x0|33) ^ 32, (0x0|30) ^ 32 },
  { 0x0521, (0x0|34) ^ 33, (0x0|31) ^ 33 },
  { 0x0441, (0x0|35) ^ 34, (0x0|32) ^ 34 },
  { 0x02A1, (0x0|36) ^ 35, (0x0|33) ^ 35 },
  { 0x0221, (0x0|37) ^ 36, (0x0|34) ^ 36 },
  { 0x0141, (0x0|38) ^ 37, (0x0|35) ^ 37 },
  { 0x0111, (0x0|39) ^ 38, (0x0|36) ^ 38 },
  { 0x0085, (0x0|40) ^ 39, (0x0|37) ^ 39 },
  { 0x0049, (0x0|41) ^ 40, (0x0|38) ^ 40 },
  { 0x0025, (0x0|42) ^ 41, (0x0|39) ^ 41 },
  { 0x0015, (0x0|43) ^ 42, (0x0|40) ^ 42 },
  { 0x0009, (0x0|44) ^ 43, (0x0|41) ^ 43 },
  { 0x0005, (0x0|45) ^ 44, (0x0|42) ^ 44 },
  { 0x0001, (0x0|45) ^ 45, (0x0|43) ^ 45 },
  { 0x5601, (0x0|46) ^ 46, (0x0|46) ^ 46 }
};
